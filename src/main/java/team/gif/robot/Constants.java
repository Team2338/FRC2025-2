...
public final class Constants {
    ...
    public static final double ALGAE_SHOOTER_NEO_VOLTAGE_FAR = 8.85;
    public static final double ALGAE_SHOOTER_NEO_VOLTAGE_CLOSE = 6.85;
    ...
    public static final double ARM_FAR_SHOOT_POSITION = 1.20; //0.195; //1.225
    public static final double ARM_CLOSE_SHOOT_POSITION = 1.01; //0.120; //0.754
